...
class UploadMedia extends Component implements HasForms, HasActions
{
    ...
    protected function getFileUploadComponent(): FileUpload
    {
        return FileUpload::make('uploads')

...
trait HasBrowseLibraryItems
{
    ...
    protected function getSearchForm(): Schema
    {
        return Schema::make($this)
            ->schema([
                TextInput::make('search')
                    ...
                    ->debounce()
                    ->afterStateUpdated(function (self $livewire) {
                        $livewire->resetPage();
                    }),
            ]);
    }

    protected function getSortOrderForm(): Schema
    {
        return Schema::make($this)
            ->schema([
    ...
    protected function applySearchTermToQuery(Builder $query, string $searchTerm): Builder
    {
        return $query
